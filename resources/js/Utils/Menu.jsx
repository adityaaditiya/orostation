        ...
        },
        {
            ...
            details: [
                ...
                },
                {
                    ...
                    href: route("transactions.cash.index", { type: "in" }),
                    active: url === "/dashboard/transactions/cash/in" ? true : false,
                    icon: <IconWallet size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["transactions-access"]),
                },
                {
                    title: "Ambil Uang Kas",
                    href: route("transactions.cash.index", { type: "out" }),
                    active: url === "/dashboard/transactions/cash/out" ? true : false,
                    icon: <IconWallet size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["transactions-access"]),
                },
            ],
