...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth']], function () {
    ...
    Route::get('/transactions/cash/{type}', [CashEntryController::class, 'index'])->whereIn('type', ['in', 'out'])->middleware('permission:transactions-access')->name('transactions.cash.index');
    Route::post('/transactions/cash/{type}', [CashEntryController::class, 'store'])->whereIn('type', ['in', 'out'])->middleware('permission:transactions-access')->name('transactions.cash.store');
